...
- `/sync-exempt <discord user>` - Exempt a user from role syncs
...
| `MEMBER_JOIN_MESSAGE_CHANNEL_ID`        | ❌        | -       | Channel ID for joins (optional)                                  |
| `RCE_USERS`                             | ❌        | -       | `;` delimited list of discord user IDs with access to `/nt-eval` |
